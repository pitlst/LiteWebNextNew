 ...
 * 
 * @description
 * 该文件定义了应用程序的主题基础配置，包括：
 * - 颜色系统（品牌色、灰度、绿色、橙色、红色）
 * - 主题模式（亮色/暗色）的样式令牌
 * - 排版系统配置
 * - 形状和阴影配置
 */
...
/**
 * 扩展 Material-UI 的类型定义
 */
declare module '@mui/material/Paper' {
    interface PalettePropsVariantOverrides {
        highlighted: true // 添加高亮变体支持
    }
}
declare module '@mui/material/styles' {
    ...
    interface Palette {
        baseShadow: string // 基础阴影颜色
    }

    interface Theme {
        vars?: Theme
        applyStyles: (mode: string, styles: any) => any // 应用样式的工具函数
    }
    ...
    interface TypeBackground {
        defaultChannel?: string // 默认背景色通道
        paperChannel?: string // 纸张背景色通道
    }
}
 ...
 * 根据主题模式生成设计令牌
 * 
 * @param {PaletteMode} mode - 主题模式（'light' | 'dark'）
 * @returns {ThemeOptions} 主题配置对象
 */
